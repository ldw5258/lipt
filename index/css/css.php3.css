...
html { background: #f6f6f1 url("img/bg-content.png"); }
...
a.link-user, a.userPage, .article a.link-user, .article a.userPage { padding-left: 14px; background: transparent url("img/icons/user_small.png") 0 50% no-repeat; }
...
.article a.external, .article a[rel~="external"] { padding-right: 16px; background: transparent url("img/icons/link_external.png") 99% 40% no-repeat; }
.article a[href^="mailto:"], .article .link-mailto { padding-right: 16px; background: url("img/icons/link_mail.png") 99% 40% no-repeat; }
.article a[href^="news://"] { padding-right: 18px; background: url("img/icons/link_news.png") 99% 40% no-repeat; }
.article a[href^="ftp://"], .article .link-ftp { padding-right: 18px; background: url("img/icons/link_download.png") 99% 40% no-repeat; }
.article a[href^="irc://"], .article .link-irc { padding-right: 18px; background: url("img/icons/link_chat.png") 99% 50% no-repeat; }
...
.section-forums #masthead { border-bottom-color: #00b6f0; }
...
.user-state a.toggle { padding-right: 15px; background: url("img/menu-arrow-w.png") 98% 50% no-repeat; }
.user-state .sub-menu { position: absolute; left: -999em; z-index: 9999; width: 140px; background: #000; border: 1px solid #030303; padding: 0 0 4px; -moz-box-shadow: 2px 2px 0 rgba(0,0,0,.2); -webkit-box-shadow: 2px 2px 0 rgba(0,0,0,.2); box-shadow: 2px 2px 0 rgba(0,0,0,.2); }
...
.user-state li { display: inline; padding-left: 5px; margin-left: 5px; border-left: 1px solid #666; }
.user-state li:first-child { border: 0; }
...
#tool-menus li a { display: block; padding: .6em 20px .7em 8px; background: transparent url("img/menu-arrow.png") 92% 0 no-repeat; }
...
/*** @Search *********/
#site-search { width: 280px; float: left; margin-top: 22px; -moz-transition: width 0.2s ease-in-out; -webkit-transition: width 0.2s ease-in-out; transition width: 0.2s ease-in-out; }
#site-search p { margin: 0; }
#site-search #q { float: left; width: 180px; padding: 5px 4px 5px 28px; margin: -2px 4px 0 0; background: #fff url("img/search-icons.png") 6px -147px no-repeat; border: 1px solid #666; color: #888; font-size: .857em; -moz-transition: width 0.2s ease-in-out; -webkit-transition: width 0.2s ease-in-out; transition width: 0.2s ease-in-out; }
...
.page-title .page-moved { float: left; width: 65%; clear: both; margin: -1.5em 0 1em; font-size: .785em; }
...
#page-buttons .page-edit a { background: #a5d9f3 url("img/button-edit.png") 0 50% repeat-x; }
...
#page-buttons .page-watch a { padding-left: 35px; background: #f2d29e url("img/button-watch.png") 0 50% repeat-x; }
...
#sessionMsg.successmsg div.inner { border: 2px solid #aaa; padding: 10px 10px 10px 50px; background: #eefdf2 url("img/icons/sysaccept.png") 10px 2px no-repeat; }
#sessionMsg.errormsg div.inner { border: 2px solid #aaa; padding: 10px 10px 10px 50px; background: #f8f8f0 url("img/icons/sysalert.png") 10px 2px no-repeat; }
...
#article-nav .anchor-tags a { background: transparent url("img/icons/tag-tiny.png") 0 50% no-repeat; }
#article-nav .anchor-files a { background: transparent url("img/icons/attach-tiny.png") 0 50% no-repeat; }
...
#page-tags .add a, #deki-page-tags-toggleview { background: #a5d9f3 url("img/button-edit.png") 0 50% repeat-x; }
...
#page-tags .taglist a, #page-tags ul.tags a { display: inline-block; padding: 2px 8px; margin-bottom: .5em; background: #f5f5f1 url("img/light-shade.png") 0 .9em repeat-x; color: #333; border: 1px solid #91918e; }
...
#deki-page-tags-edit ul.tags a.tag-delete { margin-right: 5px; width: 20px; background: transparent url("img/icons/delete.png") 50% 5px no-repeat; }
...
#page-files .add a { background: #a5d9f3 url("img/button-attach.png") 0 50% repeat-x; }
...
#attachTable a.actionmenu { padding: 0 15px 0 8px; background: transparent url("img/downarrow.png") 98% 55% no-repeat; color: #333; }
...
#pageGalleryWrap a.actionmenu { border-left: 1px solid #ccc; padding: 0 15px 0 8px; background: transparent url("img/downarrow.png") 98% 55% no-repeat; color: #333; }
...
#comments div.commentActions a { margin-right: 15px; padding: 2px 0 2px 20px; background: transparent url("img/icons/comment_edit.png") no-repeat; color: #444; }
#comments div.commentActions form.commentDelete { display: inline; }
#comments div.commentActions form.commentDelete input { border: 0; padding: 2px 0 2px 20px; background: transparent url("img/icons/comment_delete.png") no-repeat; color: #444; font-family: inherit; text-transform: none; cursor: pointer; }
...
div.quicksavedone {	display: none; width: 89px; height: 9px; background: url("/skins/common/icons/anim-save.gif") no-repeat; }
.saveMsgSuccess {	display: none; z-index: 999; border: 1px solid #aaa; padding: 4px; width: 350px; background: url("img/icons/sysaccept.png") no-repeat center left; }
...
table.table a.sort-desc { padding-right: 15px; background: transparent url("img/icons/downarrow.png") 100% 55% no-repeat; }
table.table a.sort-asc { padding-right: 15px; background: transparent url("img/icons/uparrow.png") 100% 55% no-repeat; }
...
.pageText .dp-highlighter { font: 100% "Courier New", "Andale Mono", monospace; }
...
.rtl #nav-toolbar .crumbs li.crumb-one { background: url("img/nav-arrows.png") 0 -798px no-repeat; }
